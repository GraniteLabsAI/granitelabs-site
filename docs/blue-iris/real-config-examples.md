---
title: Blue Iris – Real Configuration Examples
description: Real Blue Iris configuration examples showing camera setup, motion tuning, recording, AI, and alerts with practical context.
...
**What matters:**
- Resolution appropriate to the scene  
- FPS around ~15  
...
- Primary object detection enabled  
...
A real-world reference for how a stable Blue Iris system is configured and validated.
